...
class Slickr_Flickr_Dashboard extends Slickr_Flickr_Admin {
	private $tips = array(
			...
			'flickr_thumbnail_border' => array('heading' => 'Highlight Thumbnail Color', 'tip' => 'The highlight color appears in the photo border when the user moves their cursor over the image.'),
			...
			'flickr_galleria_theme_loading' => array('heading' => 'Galleria Theme Loading', 'tip' => 'Choose if you are using the same Galleria theme thoughout the site otherwise choose dynamic if you are using different themes on different pages.'),
