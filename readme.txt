...
* Uses "slickr-flickr" shortcode to made adding a Flickr show as easy as possible
...
* Can display captions for each photo in the slideshow using the photo title form Flickr
...
1. See http://www.wordpresswise.com/slickr-flickr for more about using the plugin



== Frequently Asked Questions ==

= The message "Please set up a Flickr User id for this slideshow" appears in place of a slideshow.
...
= The message "Please set up a Flickr tag for this slideshow" appears in place of a slideshow.

You need to specify a tag beside the shortcode. For example [slickr-flickr tag="bahamas"]

= The message "No photos available for my tag" appears in place of a slideshow.
...
= If I upload a new photo to Flickr and then tag using a phrase for which I have already got a slideshow or gallery, then will the new photos automatically appear on my blog.

Yes. The Slickr Flickr will automatically show the most recent photos.

= What happens if I try to display both landscape and portrait photos on the same slideshow?
...
= I want to customize the gallery lightbox and slideshow as my the background color of my site is dark.
...
= I have set the size to large and Flickr tells me there are no photos.
...
= How do I display photos tagged with "ice cream" from one of my friends's Flickr galleries
